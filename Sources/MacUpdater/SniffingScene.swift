...
struct SniffingScene: View {
    ...
    static let defaultThoughts: [String] = [
        ...
        "SHA256 się zgadza?",
        "Czuję starą wersję…",
        "Sniff sniff… Homebrew",
        "0x4A 0x65 0x6C 0x6C 0x79",
        "Czy plist mówi prawdę?",
        "Łapię trop wersji",
        "Wąchanie /Applications…",
        "Info.plist… mhm",
        "Trop CFBundleShortVersion",
        "Pachnie świeżym dmg",
        "Ślad prowadzi do Cellar",
        "Pulę pamięci czuć tu mocno",
        "Czy to zapach Sparkle?",
        "Mhm… kolejna wersja",
    ]
}
