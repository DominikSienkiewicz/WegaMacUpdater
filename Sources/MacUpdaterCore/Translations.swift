...
extension Translations {
    static let base: [String: String] = [
        ...
        // Caski typu `pkg` (JDK-i, zoom, google-drive) nie instalują .app — nie ma czego
        // przejąć ani z czego zrobić snapshotu. Przepięcie takiej aplikacji pod caska nie ma
        // sensu i jest odrzucane; zwykła aktualizacja idzie dalej, tyle że bez rollbacku.
        ...
        "%@: ten cask instaluje pakiet .pkg — aktualizacja pójdzie bez ochrony rollbackiem.":
            "%@: this cask installs a .pkg package — the update will run without rollback protection.",
        ...
        "Ostatni skan nie dostał odpowiedzi od wszystkich źródeł — odśwież, żeby poznać pełną listę.": "The last scan didn't hear back from every source — refresh to see the full list.",
        "Nie wiem, czy wszystko aktualne": "I can't tell whether everything is up to date",
        "Ostatni skan nie dostał odpowiedzi od wszystkich źródeł — pusta lista nic tu nie znaczy. Odśwież, gdy wróci połączenie.": "The last scan didn't hear back from every source — an empty list means nothing here. Refresh once you're back online.",
        ...
        // REL-05 — the "App Management" TCC refusal, named instead of left as raw stderr.
        "Brak uprawnienia „Zarządzanie aplikacjami”": "“App Management” permission missing",
        "%@ macOS nie pozwolił Wedze podmienić aplikacji w /Applications. Przyznaj uprawnienie „Zarządzanie aplikacjami” w Ustawieniach systemowych → Prywatność i bezpieczeństwo.": "%@ macOS did not let Wega replace an app in /Applications. Grant the “App Management” permission in System Settings → Privacy & Security.",
        "Otwórz ustawienia prywatności": "Open privacy settings",
        "Brak uprawnienia „Zarządzanie aplikacjami” — przyznaj je w Ustawieniach systemowych.": "“App Management” permission missing — grant it in System Settings.",
...
extension Translations {
    static let operations: [String: String] = [
        ...
        "Brak opublikowanych notatek": "No notes published",
        "…i %@ wcześniejszych wydań": "…and %@ earlier releases",
        "Nie udało się pobrać notatek wydania": "Couldn't fetch the release notes",
